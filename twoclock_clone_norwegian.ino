...
void phobic() {
  matrix.drawFastHLine(5, 0, 3, RED);
  matrix.drawFastHLine(5, 1, 3, RED);
}
void fem_() {
  matrix.drawFastHLine(0, 0, 3, RED);
}
void ti_() {
  matrix.drawFastHLine(3, 0, 2, BLUE);  // Row#3, Line#0
}
void kvart_() {
  matrix.drawFastHLine(0, 1, 5, YELLOW);  // Row#0, Line#1
}
void halv_() {
  matrix.drawFastHLine(0, 3, 4, GREEN); 
}
void pa_() {
  matrix.drawFastHLine(0, 2, 2, GREEN);
}
void over_() {
  matrix.drawFastHLine(3, 2, 4, CYAN);
}

void ett() {
  matrix.drawFastHLine(5, 6, 3, MAGENTA);
}
void to() {
  matrix.drawFastHLine(0, 5, 2, WHITE);
}
void tre() {
  matrix.drawFastVLine(0, 5, 3, RED);
}
void fire() {
  matrix.drawFastHLine(0, 4, 4, BLUE);
}
void fem() {
  matrix.drawFastHLine(5, 3, 3, YELLOW);
}
void seks() {
  matrix.drawFastHLine(4, 4, 4, GREEN);
}
void sju() {
  matrix.drawFastHLine(4, 5, 3, CYAN);
}
void atte() {
  matrix.drawFastHLine(2, 6, 4, MAGENTA);
}
void ni() {
  matrix.drawFastHLine(6, 7, 2, WHITE);
}
void ti() {
  matrix.drawFastVLine(7, 6, 2, RED);
}
void elleve() {
  matrix.drawFastHLine(0, 7, 6, BLUE);
}
void tolv() {
